...
Public Class frmMain
    '********************************************************************************
    ' Class-level arrays for the amounts
    ...
    ' calles the change calculator when the Make Change button is clicked
    ...
    Private Sub StartQuizBtn_Click(sender As Object, e As EventArgs) Handles StartQuizBtn.Click
        ...
        Dim limitAmounts() As Integer = {5, 10, 20, 50, 100, 500}
    ...
    Private Sub AmountTxt_Click(sender As Object, e As EventArgs) Handles AmountTxt.Click
        AmountTxt.SelectAll()
    ...
    Private Sub AmountTxt_KeyPress(sender As Object, e As KeyPressEventArgs) Handles AmountTxt.KeyPress
    ...
    Private Sub CheckBtn_Click(sender As Object, e As EventArgs) Handles CheckBtn.Click
        ...
        If Not isCorrect Then
            ...
            ClearSystemText()
        Else
            MessageBox.Show("Great Job! You got them all right!", "Results", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
        End If
    End Sub
End Class
